...
object Part1 {
  def playMemoryGame(input: IndexedSeq[Int]): Iterator[Int] = {
    Iterator
      .from(1)
      .scanLeft[Tuple2[Int, Map[Int, Seq[Int]]]](-1, Map[Int, Seq[Int]]().withDefault(_ => Seq[Int]()))({
  ...
  def getNthMemoryGameNumberSpoken(input: IndexedSeq[Int], n: Int): Int = getNthElementOfIterator(playMemoryGame(input), n)
